...
const PrintInvoice = ({ selectedInvoice, isModalOpen, setIsModalOpen }) => {
                ...
                <tfoot>
                  <tr>
                    ...
                    <th className="text-right pt-4" scope="row">
                      <span className="font-normal text-slate-700">{selectedInvoice?.subTotal}₺</span>
                    </th>
                  </tr>
                  <tr>
                    <th
                    ...
                    <th className="text-right pt-4" scope="row">
                      <span className="font-normal text-red-600">+{selectedInvoice?.tax}₺</span>
                    </th>
                  </tr>
                  <tr>
                    <th
                    ...
                    <th className="text-right pt-4" scope="row">
                      <span className="font-normal text-slate-700">{selectedInvoice?.totalAmount}₺</span>
                    </th>
                  </tr>
                </tfoot>
              </table>
